%a=double(imread('DSC_0075acr.tif'))/257; [a(:,:,1),a(:,:,2),a(:,:,3)] = color2Y(a);  a1=uint16(round(a*16));
%a=double(imread('DSC_0076acr.tif'))/257; [a(:,:,1),a(:,:,2),a(:,:,3)] = color2Y(a);  a2=uint16(round(a*16));
%a=double(imread('DSC_0113acr.tif'))/257; [a(:,:,1),a(:,:,2),a(:,:,3)] = color2Y(a);  a3=uint16(round(a*16));
%a=double(imread('DSC_0180acr.tif'))/257; [a(:,:,1),a(:,:,2),a(:,:,3)] = color2Y(a);  a4=uint16(round(a*16));
%a=double(imread('DSC_0183acr.tif'))/257; [a(:,:,1),a(:,:,2),a(:,:,3)] = color2Y(a);  a5=uint16(round(a*16));
%a=double(imread('DSC_0184acr.tif'))/257; [a(:,:,1),a(:,:,2),a(:,:,3)] = color2Y(a);  a6=uint16(round(a*16));

%set 2 ====================================================================================================
%a=double(imread('DSC_0410acr.tif'))/257; [a(:,:,1),a(:,:,2),a(:,:,3)] = color2Y(a);  a1=uint16(round(a*16));
%a=double(imread('DSC_0415acr.tif'))/257; [a(:,:,1),a(:,:,2),a(:,:,3)] = color2Y(a);  a2=uint16(round(a*16));
%a=double(imread('DSC_0436acr.tif'))/257; [a(:,:,1),a(:,:,2),a(:,:,3)] = color2Y(a);  a3=uint16(round(a*16));
%a=double(imread('DSC_0438acr.tif'))/257; [a(:,:,1),a(:,:,2),a(:,:,3)] = color2Y(a);  a4=uint16(round(a*16));
%a=double(imread('DSC_0455acr.tif'))/257; [a(:,:,1),a(:,:,2),a(:,:,3)] = color2Y(a);  a5=uint16(round(a*16));
%a=double(imread('DSC_0461acr.tif'))/257; [a(:,:,1),a(:,:,2),a(:,:,3)] = color2Y(a);  a6=uint16(round(a*16));
...
%Nikon850D HDR (2 images) ===================================================================================================
a=double(imread('C:\image\images4HDR\nikon850D5.tif'))/257; [a(:,:,1),a(:,:,2),a(:,:,3)] = color2Y(a);  a1=uint16(round(a*16));
a=double(imread('C:\image\images4HDR\nikon850D6.tif'))/257; [a(:,:,1),a(:,:,2),a(:,:,3)] = color2Y(a);  a2=uint16(round(a*16));


%Sigma ====================================================================================================
%a=double(imread('sigma1.tif'))/257; [a(:,:,1),a(:,:,2),a(:,:,3)] = color2Y(a);  a1=uint16(round(a*16));
%a=double(imread('sigma2.tif'))/257; [a(:,:,1),a(:,:,2),a(:,:,3)] = color2Y(a);  a2=uint16(round(a*16));
%a=double(imread('sigma3.tif'))/257; [a(:,:,1),a(:,:,2),a(:,:,3)] = color2Y(a);  a3=uint16(round(a*16));
%a=double(imread('sigma4.tif'))/257; [a(:,:,1),a(:,:,2),a(:,:,3)] = color2Y(a);  a4=uint16(round(a*16));
%a=double(imread('sigma5.tif'))/257; [a(:,:,1),a(:,:,2),a(:,:,3)] = color2Y(a);  a5=uint16(round(a*16));
%a=double(imread('sigma6.tif'))/257; [a(:,:,1),a(:,:,2),a(:,:,3)] = color2Y(a);  a6=uint16(round(a*16));
%a=double(imread('sigma7.tif'))/257; [a(:,:,1),a(:,:,2),a(:,:,3)] = color2Y(a);  a7=uint16(round(a*16));
...
%Fuji set3==========================================================================================================
%a=double(imread('C:\image\images4HDR\Fuji5.tif'))/257; [a(:,:,1),a(:,:,2),a(:,:,3)] = color2Y(a);  a1=uint16(round(a*16));
%a=double(imread('C:\image\images4HDR\Fuji6.tif'))/257; [a(:,:,1),a(:,:,2),a(:,:,3)] = color2Y(a);  a2=uint16(round(a*16));
%a=double(imread('C:\image\images4HDR\Fuji7.tif'))/257; [a(:,:,1),a(:,:,2),a(:,:,3)] = color2Y(a);  a3=uint16(round(a*16));
    
    
111
[L1,L2,L3]=size(a1);
bitdepth='uint16'; byte=2; zro=zeros([L2 L1]/2);
outfile='nikon850D_color_HDR.yuv';  fid=fopen(outfile,'w+');
...
%outfile='fuji_color_set3.yuv';  fid=fopen(outfile,'w+');
...
222
%~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~
%fidY=fopen('fujiY_set2.yuv','w+'); %fidU=fopen('fujiU_set2.yuv','w+'); fidV=fopen('fujiV_set2.yuv','w+');
%fidY=fopen('fujiY_set3.yuv','w+'); %fidU=fopen('fujiU_set3.yuv','w+'); fidV=fopen('fujiV_set3.yuv','w+');
fidY=fopen('nikon850DY_HDR.yuv','w+'); %fidU=fopen('fujiU_set3.yuv','w+'); fidV=fopen('fujiV_set3.yuv','w+');
