function [cf0,dn]=trim_coef_5pix(cf0,sb,delta,T,T2,sb2)
...
while lg-ia>=5
   ...
   if (lenp1>lenp) & (lenp6>lenp)
      ...
      if ssb < th
         ...
         %gc(ia+4)=gc(ia+4)+lenp2+lenp3+lenp4+lenp5+lenp6;  %<== mistake here, corrected 03/04/2015
         gc(ia+5)=gc(ia+5)+lenp1+lenp2+lenp3+lenp4+lenp5;
