function [cf0,sn,ptr]=de_subband_sub1_L2(biny,lenz,ptr)

inv=biny(ptr); ptr=ptr+1;  %modified %Dec.30, 2013
[z10,ptr]=de_zone(biny,lenz,ptr); 
if inv==1,  z10=1-z10;  end  %modified %Dec.30, 2013
inv1=biny(ptr); ptr=ptr+1; %modified %Mar.13, 2014
[cf1k,ptr]=de_zone(biny,lenz-sum(z10),ptr);
if inv1==1,  cf1k=1-cf1k;  end  %modified  %Mar.13, 2014
...
%   sum(z10), length(cf2), length(cf1k), length(z10) %%%%%%%%%%%%%%%%%%%%%%%%%%
   ...
   inv2=biny(ptr); ptr=ptr+1; %modified %Mar.13, 2014
   [z2,ptr]=de_zone(biny,sum(z10),ptr);
   if inv2==1,  z2=1-z2;  end  %modified  %Mar.13, 2014
