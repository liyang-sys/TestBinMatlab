function [Ncfp4a,Ncfp8a,Nf26a,max4,max8,max26,Ncfp4,Ncfp8,Nf26,Ncfp4Ha,NHar,NHarp]=ssparsity(cf_cfp8_only,r,c,w,delta)
...
qcfp4=abs(quanTHD(cfp4,delta,delta));
qcfp4Ha=abs(quanTHD(cfp4Ha,delta,delta));
qcfp8=abs(quanTHD(cfp8,delta,delta));
qf26=abs(quanTHD(f26,delta,delta));
