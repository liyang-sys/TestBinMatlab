function [cf0,sn,ptr,cfw]=de_sub3d_sub2(biny,lenz,ptr)
...
while flg>0
   if decomp==1
      cs=1; [zz{decomp},cfk{decomp},ptr,thdn{decomp}]=de_sub3d_sub2_sub(biny,thdd,ptr,cs,lencf1w);
   elseif decomp==2
      cs=2; [zz{decomp},cfk{decomp},ptr,thdn{decomp}]=de_sub3d_sub2_sub(biny,thdd,ptr,cs);
   else
      cs=3; [zz{decomp},cfk{decomp},ptr,thdn{decomp}]=de_sub3d_sub2_sub(biny,thdd,ptr,cs);
   end
   flg=biny(ptr); ptr=ptr+1; 
   thdd=thdn{decomp}*2;
   decomp=decomp+1; 
