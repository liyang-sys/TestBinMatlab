...
if delH~=0
   ...
   if length(inc)>=3
      %The 3D version uses 'find_2s_inc0.m' instead of 'find_2s_inc.m' in the 2D version.
      inc0=inc;
      inc=find_2s_inc0(dim,delH,inc,p2s); len_inc=length(inc);
      if inc(1)+dim<=0, inc=inc0; len_inc=length(inc);  end
   end
   %~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~
