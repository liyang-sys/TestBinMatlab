function [r1,c1,finish,Hn_next,Wn_next,iw,ih]=modify_Hilbert2D_ScanByBlock(r,c,Hn,Wn,Hn0,idxW,w,iw,h,ih,p2s)
...
while bitshift(Wn,1)>Hn  &&  Wn_next<=Hn_next
   ...
   idx=idxW(iw);
   [r0,c0]=modifyHilbert2D_BlockDeformation(r,c,idx,Hn,p2s);
