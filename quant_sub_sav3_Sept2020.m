...
lennc=max(abscf);  %note: the mininum of abscf is 1 here, not 0. <== No, there are chances to be 0 !!!  5/10/17
...
if lennc>=6
   ...
   if lennc/10<120
      ...
      if (non<0.6  &&  r61<0.71  &&  sum(xx(16:20))<sum(xx(21:25)) )  ||  (non<0.36 && r61<0.6) %trim:
         ...
         h=1; %Here 'h' is redundent, and is never used.
